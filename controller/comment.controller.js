...
exports.createComment = async (req, res) => {
    ...
    if (!newComment) return res.status(500).json({message: "Une erreur interne est survenue"});
...
exports.editComment = async (req, res) => {
    ...
    if(!commentId || !content || !title) return res.status(400).json({message: "Le contenu du commentaire est nécéssaire pour continuer"});
